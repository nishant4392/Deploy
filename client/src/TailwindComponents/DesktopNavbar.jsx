  ...
  return (
    <div className="border-2 border-blue-500 flex items-center w-full h-16 overflow-hidden">
      ...
      <div className="relative border-2 border-blue-500 flex items-center w-full h-full justify-center">
        ...
        >
          <div className="relative flex justify-center cursor-pointer items-center">Parent 1</div>
          <div
            className={`relative ${
          ...
          <div className="relative flex justify-center items-center cursor-pointer">Parent 3</div>
          <div className="relative flex justify-center items-center cursor-pointer">Parent 4</div>
        </div>
        <div
          className={`absolute ${
        ...
        >
          <div className="relative flex items-center m-0 cursor-pointer">Child 2-1</div>
          <div className="relative flex items-center m-0 cursor-pointer">Child 2-2</div>
          <div className="relative flex items-center m-0 cursor-pointer">Child 2-3</div>
          <div className="relative flex items-center m-0 cursor-pointer" >Child 2-4</div>
        </div>
      </div>
    </div>
  );
