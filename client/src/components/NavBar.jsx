...
const NavBar = () => {
  ...
  return (
    <div className="w-full" data-modal-target="popup-modal">
        ...
        <div className="relative w-full max-w-md max-h-full ">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 text-center">
              ...
              <div
                onClick={() =>{otp.length>0 ? console.log('good'):setError(true)}}
              ...
              <button
                ...
                type="button"
                onClick={() => setShow(false)}
                className="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
              >
                Resend OTP
              </button>
            </div>
